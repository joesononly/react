...
import Table from '../pages/Business/Table';
import Form from '../pages/Business/Form';
import TableAdminCopy from '../pages/System/RelationAdmin/TableCopyAdmin';
import EditTable from '@/components/Table/EditTable';
import TableAdmin from '../pages/System/RelationAdmin/TableAdmin';
import BusinessAdmin from '../pages/System/RelationAdmin/BusinessAdmin';
import ORMAdmin from '@/pages/System/RelationAdmin/ORMAdmin';
        ...
        <Content className="content">
          <ErrorBoundary location={props.location}>
            <CacheSwitch>
              ...
              <Route exact path="/business/table" component={TableAdmin} />
              <Route exact path="/business/component" component={ORMAdmin} />
              {/*<Route exact path="/business/object" component={BusinessObject} />*/}
